...
var _ProgressBar = class _ProgressBar {
  constructor() {
     ...
     * @group Props
     */
    __publicField(this, "mode", "determinate");
    /**
...
__publicField(_ProgressBar, "ɵfac", function ProgressBar_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _ProgressBar)();
});
__publicField(_ProgressBar, "ɵcmp", ɵɵdefineComponent({
  type: _ProgressBar,
...
__publicField(_ProgressBarModule, "ɵfac", function ProgressBarModule_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _ProgressBarModule)();
});
__publicField(_ProgressBarModule, "ɵmod", ɵɵdefineNgModule({
  type: _ProgressBarModule,
  declarations: [ProgressBar],
  imports: [CommonModule],
  exports: [ProgressBar]
}));
__publicField(_ProgressBarModule, "ɵinj", ɵɵdefineInjector({
  imports: [CommonModule]
}));
...
//# sourceMappingURL=chunk-LY6UOHTJ.js.map
