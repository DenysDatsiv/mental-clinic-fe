...
var _AriaDescriber = class _AriaDescriber {
  ...
  ngOnDestroy() {
    var _a;
    const describedElements = this._document.querySelectorAll("[".concat(CDK_DESCRIBEDBY_HOST_ATTRIBUTE, '="').concat(this._id, '"]'));
  ...
  _createMessagesContainer() {
    ...
    const serverContainers = this._document.querySelectorAll(".".concat(containerClassName, '[platform="server"]'));
...
var FocusTrap = class {
  ...
  _getRegionBoundary(bound) {
    const markers = this._element.querySelectorAll("[cdk-focus-region-".concat(bound, "], ") + "[cdkFocusRegion".concat(bound, "], ") + "[cdk-focus-".concat(bound, "]"));
...
var _LiveAnnouncer = class _LiveAnnouncer {
  ...
  _createLiveElement() {
    ...
    liveEl.id = "cdk-live-announcer-".concat(uniqueIds++);
...
var SingleAxisSortStrategy = class {
  ...
  sort(item, pointerX, pointerY, pointerDelta) {
    ...
    siblings.forEach((sibling, index) => {
      ...
      if (isHorizontal) {
        elementToOffset.style.transform = combineTransforms("translate3d(".concat(transformAmount, "px, 0, 0)"), sibling.initialTransform);
        adjustDomRect(sibling.clientRect, 0, offset);
      } else {
        elementToOffset.style.transform = combineTransforms("translate3d(0, ".concat(transformAmount, "px, 0)"), sibling.initialTransform);
    ...
    ref.beforeStarted.subscribe(() => {
      ...
      if (this.elementContainerSelector) {
        ...
        if (!container && (typeof ngDevMode === "undefined" || ngDevMode)) {
          throw new Error('CdkDropList could not find an element container matching the selector "'.concat(this.elementContainerSelector, '"'));
        }
...
var _AngleDoubleDownIcon = class _AngleDoubleDownIcon extends BaseIcon {
};
__publicField(_AngleDoubleDownIcon, "ɵfac", /* @__PURE__ */ (() => {
...
__publicField(_AngleDoubleDownIcon, "ɵcmp", ɵɵdefineComponent({
...
var AngleDoubleDownIcon = _AngleDoubleDownIcon;
(() => {
...
var _AngleDoubleUpIcon = class _AngleDoubleUpIcon extends BaseIcon {
};
__publicField(_AngleDoubleUpIcon, "ɵfac", /* @__PURE__ */ (() => {
...
__publicField(_AngleDoubleUpIcon, "ɵcmp", ɵɵdefineComponent({
...
var AngleDoubleUpIcon = _AngleDoubleUpIcon;
(() => {
...
//# sourceMappingURL=chunk-IEZ2XQR2.js.map
