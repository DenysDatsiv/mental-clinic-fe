...
var _SelectButton = class _SelectButton {
  constructor(cd) {
     ...
     * @group Props
     */
    __publicField(this, "unselectable", false);
    /**
     ...
     * @group Props
     */
    __publicField(this, "allowEmpty", true);
    /**
     ...
     * @group Emits
     */
    __publicField(this, "onOptionClick", new EventEmitter());
    /**
    ...
    __publicField(this, "focusedIndex", 0);
    this.cd = cd;
  }
  get selectButtonTemplate() {
    var _a;
    return (_a = this.itemTemplate) == null ? void 0 : _a.template;
  }
  get equalityKey() {
...
__publicField(_SelectButton, "ɵfac", function SelectButton_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _SelectButton)(ɵɵdirectiveInject(ChangeDetectorRef));
});
__publicField(_SelectButton, "ɵcmp", ɵɵdefineComponent({
  type: _SelectButton,
...
var SelectButton = _SelectButton;
(() => {
...
var _SelectButtonModule = class _SelectButtonModule {
};
__publicField(_SelectButtonModule, "ɵfac", function SelectButtonModule_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _SelectButtonModule)();
});
__publicField(_SelectButtonModule, "ɵmod", ɵɵdefineNgModule({
  type: _SelectButtonModule,
  declarations: [SelectButton],
  imports: [CommonModule, RippleModule, SharedModule, AutoFocusModule],
  exports: [SelectButton, SharedModule]
}));
__publicField(_SelectButtonModule, "ɵinj", ɵɵdefineInjector({
  imports: [CommonModule, RippleModule, SharedModule, AutoFocusModule, SharedModule]
}));
var SelectButtonModule = _SelectButtonModule;
(() => {
...
//# sourceMappingURL=chunk-5HJ4S3KO.js.map
