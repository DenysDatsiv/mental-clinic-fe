...
var _Timeline = class _Timeline {
  constructor(el) {
    ...
    __publicField(this, "oppositeTemplate");
    __publicField(this, "markerTemplate");
    this.el = el;
  }
  getBlockableElement() {
...
__publicField(_Timeline, "ɵfac", function Timeline_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _Timeline)(ɵɵdirectiveInject(ElementRef));
});
__publicField(_Timeline, "ɵcmp", ɵɵdefineComponent({
  type: _Timeline,
...
var _TimelineModule = class _TimelineModule {
};
__publicField(_TimelineModule, "ɵfac", function TimelineModule_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _TimelineModule)();
});
__publicField(_TimelineModule, "ɵmod", ɵɵdefineNgModule({
  type: _TimelineModule,
  declarations: [Timeline],
  imports: [CommonModule],
  exports: [Timeline, SharedModule]
}));
__publicField(_TimelineModule, "ɵinj", ɵɵdefineInjector({
  imports: [CommonModule, SharedModule]
}));
var TimelineModule = _TimelineModule;
(() => {
