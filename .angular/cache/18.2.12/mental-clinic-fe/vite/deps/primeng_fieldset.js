...
var _Fieldset = class _Fieldset {
  constructor(el) {
    ...
    __publicField(this, "collapseIconTemplate");
    __publicField(this, "expandIconTemplate");
    this.el = el;
  }
  get id() {
...
__publicField(_Fieldset, "ɵfac", function Fieldset_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _Fieldset)(ɵɵdirectiveInject(ElementRef));
});
__publicField(_Fieldset, "ɵcmp", ɵɵdefineComponent({
  type: _Fieldset,
...
var _FieldsetModule = class _FieldsetModule {
};
__publicField(_FieldsetModule, "ɵfac", function FieldsetModule_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _FieldsetModule)();
});
__publicField(_FieldsetModule, "ɵmod", ɵɵdefineNgModule({
  type: _FieldsetModule,
  declarations: [Fieldset],
  imports: [CommonModule, RippleModule, MinusIcon, PlusIcon],
  exports: [Fieldset, SharedModule]
}));
__publicField(_FieldsetModule, "ɵinj", ɵɵdefineInjector({
  imports: [CommonModule, RippleModule, MinusIcon, PlusIcon, SharedModule]
}));
var FieldsetModule = _FieldsetModule;
(() => {
