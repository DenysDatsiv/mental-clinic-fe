...
var _TriStateCheckbox = class _TriStateCheckbox {
  constructor(cd, config) {
     ...
     * @group Props
     */
    __publicField(this, "checkboxTrueIcon");
    /**
     * Specifies the icon for checkbox false value.
     * @group Props
     */
    __publicField(this, "checkboxFalseIcon");
    /**
    ...
    __publicField(this, "uncheckIconTemplate");
...
__publicField(_TriStateCheckbox, "ɵfac", function TriStateCheckbox_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _TriStateCheckbox)(ɵɵdirectiveInject(ChangeDetectorRef), ɵɵdirectiveInject(PrimeNGConfig));
});
__publicField(_TriStateCheckbox, "ɵcmp", ɵɵdefineComponent({
...
var TriStateCheckbox = _TriStateCheckbox;
(() => {
...
var _TriStateCheckboxModule = class _TriStateCheckboxModule {
};
__publicField(_TriStateCheckboxModule, "ɵfac", function TriStateCheckboxModule_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _TriStateCheckboxModule)();
});
__publicField(_TriStateCheckboxModule, "ɵmod", ɵɵdefineNgModule({
...
__publicField(_TriStateCheckboxModule, "ɵinj", ɵɵdefineInjector({
  imports: [CommonModule, SharedModule, AutoFocusModule, CheckIcon, TimesIcon, SharedModule]
}));
var TriStateCheckboxModule = _TriStateCheckboxModule;
(() => {
...
//# sourceMappingURL=chunk-OTXM3FJP.js.map
