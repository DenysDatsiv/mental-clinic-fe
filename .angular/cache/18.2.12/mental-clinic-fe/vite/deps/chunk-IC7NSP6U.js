...
var _Tooltip = class _Tooltip {
  constructor(platformId, el, zone, config, renderer, viewContainer) {
     ...
     * @group Props
     */
    __publicField(this, "tooltipPosition");
    /**
     * Event to show the tooltip.
     * @group Props
     */
    __publicField(this, "tooltipEvent", "hover");
    /**
     ...
     * @group Props
     */
    __publicField(this, "positionStyle");
    /**
     ...
     * @group Props
     */
    __publicField(this, "tooltipZIndex");
    /**
     ...
     * @group Props
     */
    __publicField(this, "positionTop");
    /**
     * Specifies the additional horizontal offset of the tooltip from its default position.
     * @group Props
     */
    __publicField(this, "positionLeft");
    /**
     * Whether to hide tooltip when hovering over tooltip content.
     * @group Props
     */
    __publicField(this, "autoHide", true);
    /**
     ...
     * @group Props
     */
    __publicField(this, "hideOnEscape", true);
    /**
  ...
  bindContainerMouseleaveListener() {
    ...
    if (!this.containerMouseleaveListener) {
      const targetEl = (_a = this.container) != null ? _a : this.container.nativeElement;
...
__publicField(_Tooltip, "ɵfac", function Tooltip_Factory(__ngFactoryType__) {
...
__publicField(_Tooltip, "ɵdir", ɵɵdefineDirective({
  type: _Tooltip,
  selectors: [["", "pTooltip", ""]],
...
__publicField(_TooltipModule, "ɵfac", function TooltipModule_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _TooltipModule)();
});
__publicField(_TooltipModule, "ɵmod", ɵɵdefineNgModule({
  type: _TooltipModule,
  declarations: [Tooltip],
  imports: [CommonModule],
  exports: [Tooltip]
}));
__publicField(_TooltipModule, "ɵinj", ɵɵdefineInjector({
  imports: [CommonModule]
}));
...
//# sourceMappingURL=chunk-IC7NSP6U.js.map
