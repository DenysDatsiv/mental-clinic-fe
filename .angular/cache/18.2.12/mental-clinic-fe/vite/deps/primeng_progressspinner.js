...
var _ProgressSpinner = class _ProgressSpinner {
  constructor() {
    /**
     ...
     * @group Props
     */
    __publicField(this, "fill", "none");
    /**
     * Duration of the rotate animation.
     * @group Props
     */
    __publicField(this, "animationDuration", "2s");
    /**
...
__publicField(_ProgressSpinner, "ɵfac", function ProgressSpinner_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _ProgressSpinner)();
});
__publicField(_ProgressSpinner, "ɵcmp", ɵɵdefineComponent({
...
var ProgressSpinner = _ProgressSpinner;
(() => {
...
var _ProgressSpinnerModule = class _ProgressSpinnerModule {
};
__publicField(_ProgressSpinnerModule, "ɵfac", function ProgressSpinnerModule_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _ProgressSpinnerModule)();
});
__publicField(_ProgressSpinnerModule, "ɵmod", ɵɵdefineNgModule({
  type: _ProgressSpinnerModule,
  declarations: [ProgressSpinner],
  imports: [CommonModule],
  exports: [ProgressSpinner]
}));
__publicField(_ProgressSpinnerModule, "ɵinj", ɵɵdefineInjector({
  imports: [CommonModule]
}));
var ProgressSpinnerModule = _ProgressSpinnerModule;
(() => {
