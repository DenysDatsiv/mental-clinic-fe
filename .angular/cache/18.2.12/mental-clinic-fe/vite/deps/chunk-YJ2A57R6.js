...
var _UITreeNode = class _UITreeNode {
  constructor(tree) {
    ...
    __publicField(this, "loadingMode");
    __publicField(this, "tree");
    __publicField(this, "timeout");
    __publicField(this, "draghoverPrev");
    __publicField(this, "draghoverNext");
    __publicField(this, "draghoverNode");
    this.tree = tree;
  }
  get ariaSelected() {
  ...
  getIcon() {
    ...
    else icon = this.node.expanded && this.node.children && ((_a = this.node.children) == null ? void 0 : _a.length) ? this.node.expandedIcon : this.node.collapsedIcon;
  ...
  onDragStart(event) {
    ...
    if (this.tree.draggableNodes && this.node.draggable !== false) {
      ...
      this.tree.dragDropService.startDrag({
        tree: this,
        node: this.node,
        subNodes: ((_a = this.node) == null ? void 0 : _a.parent) ? this.node.parent.children : this.tree.value,
        index: this.index,
  ...
  onDropNode(event) {
    var _a;
    if (this.tree.droppableNodes && ((_a = this.node) == null ? void 0 : _a.droppable) !== false) {
      let dragNode = this.tree.dragNode;
  ...
  onDropNodeDragEnter(event) {
    var _a;
    if (this.tree.droppableNodes && ((_a = this.node) == null ? void 0 : _a.droppable) !== false && this.tree.allowDrop(this.tree.dragNode, this.node, this.tree.dragNodeScope)) {
  ...
  onKeyDown(event) {
    var _a;
    if (!this.isSameNode(event) || this.tree.contextMenu && ((_a = this.tree.contextMenu.containerViewChild) == null ? void 0 : _a.nativeElement.style.display) === "block") {
      return;
    }
    switch (event.code) {
      case "ArrowDown":
  ...
  onArrowRight(event) {
    var _a;
    if (!((_a = this.node) == null ? void 0 : _a.expanded) && !this.tree.isNodeLeaf(this.node)) {
      this.expand(event);
  ...
  onArrowLeft(event) {
    var _a, _b;
    const nodeElement = event.target.getAttribute("data-pc-section") === "toggler" ? event.target.closest('[role="treeitem"]') : event.target;
    if (this.level === 0 && !((_a = this.node) == null ? void 0 : _a.expanded)) {
      return false;
    }
    if ((_b = this.node) == null ? void 0 : _b.expanded) {
      this.collapse(event);
      return;
    }
  ...
  getParentNodeElement(nodeElement) {
    var _a, _b;
    const parentNodeElement = (_b = (_a = nodeElement.parentElement) == null ? void 0 : _a.parentElement) == null ? void 0 : _b.parentElement;
    return (parentNodeElement == null ? void 0 : parentNodeElement.tagName) === "P-TREENODE" ? parentNodeElement : null;
  }
  focusNode(element) {
  ...
  focusVirtualNode() {
    this.timeout = setTimeout(() => {
      var _a, _b, _c;
      let node = DomHandler.findSingle(document.body, '[data-id="'.concat((_c = (_a = this.node) == null ? void 0 : _a.key) != null ? _c : (_b = this.node) == null ? void 0 : _b.data, '"]'));
      DomHandler.focus(node);
    }, 1);
  }
};
__publicField(_UITreeNode, "ICON_CLASS", "p-treenode-icon ");
__publicField(_UITreeNode, "ɵfac", function UITreeNode_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _UITreeNode)(ɵɵdirectiveInject(forwardRef(() => Tree)));
});
__publicField(_UITreeNode, "ɵcmp", ɵɵdefineComponent({
  type: _UITreeNode,
...
var _Tree = class _Tree {
  constructor(el, dragDropService, config, cd) {
     ...
     * @group Props
     */
    __publicField(this, "loadingMode", "mask");
    /**
     ...
     * @group Props
     */
    __publicField(this, "layout", "vertical");
    /**
     * Scope of the draggable nodes to match a droppableScope.
     * @group Props
     */
    __publicField(this, "draggableScope");
    /**
     * Scope of the droppable nodes to match a draggableScope.
     * @group Props
     */
    __publicField(this, "droppableScope");
    /**
     * Whether the nodes are draggable.
     * @group Props
     */
    __publicField(this, "draggableNodes");
    /**
     * Whether the nodes are droppable.
     * @group Props
     */
    __publicField(this, "droppableNodes");
    /**
     ...
     * @group Props
     */
    __publicField(this, "togglerAriaLabel");
    /**
     ...
     * @group Props
     */
    __publicField(this, "validateDrop");
    /**
     ...
     * @group Props
     */
    __publicField(this, "indentation", 1.5);
    /**
     * Custom templates of the component.
     * @group Props
     */
    __publicField(this, "_templateMap");
    /**
     ...
     */
    __publicField(this, "_virtualNodeHeight");
    /**
     ...
     * @group Emits
     */
    __publicField(this, "onNodeContextMenuSelect", new EventEmitter());
    /**
     * Callback to invoke when a node is dropped.
     * @param {TreeNodeDropEvent} event - Node drop event.
     * @group Emits
     */
    __publicField(this, "onNodeDrop", new EventEmitter());
    /**
    ...
    __publicField(this, "nodeTouched");
    __publicField(this, "dragNodeTree");
    __publicField(this, "dragNode");
    __publicField(this, "dragNodeSubNodes");
    __publicField(this, "dragNodeIndex");
    __publicField(this, "dragNodeScope");
    __publicField(this, "dragHover");
    __publicField(this, "dragStartSubscription");
    __publicField(this, "dragStopSubscription");
    this.el = el;
  ...
  hasFilterActive() {
    var _a, _b;
    return this.filter && ((_b = (_a = this.filterViewChild) == null ? void 0 : _a.nativeElement) == null ? void 0 : _b.value.length) > 0;
  }
  ...
  scrollToVirtualIndex(index) {
    var _a;
    this.virtualScroll && ((_a = this.scroller) == null ? void 0 : _a.scrollToIndex(index));
  }
  /**
   * Scrolls to virtual index.
...
__publicField(_Tree, "ɵfac", function Tree_Factory(__ngFactoryType__) {
...
__publicField(_Tree, "ɵcmp", ɵɵdefineComponent({
  type: _Tree,
  selectors: [["p-tree"]],
...
__publicField(_TreeModule, "ɵfac", function TreeModule_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _TreeModule)();
});
__publicField(_TreeModule, "ɵmod", ɵɵdefineNgModule({
  type: _TreeModule,
...
__publicField(_TreeModule, "ɵinj", ɵɵdefineInjector({
...
//# sourceMappingURL=chunk-YJ2A57R6.js.map
