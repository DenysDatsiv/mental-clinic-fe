...
var _EyeSlashIcon = class _EyeSlashIcon extends BaseIcon {
  constructor() {
    super(...arguments);
...
__publicField(_EyeSlashIcon, "ɵfac", /* @__PURE__ */ (() => {
...
__publicField(_EyeSlashIcon, "ɵcmp", ɵɵdefineComponent({
  type: _EyeSlashIcon,
...
var EyeSlashIcon = _EyeSlashIcon;
(() => {
...
var _PasswordDirective = class _PasswordDirective {
  constructor(document2, platformId, renderer, el, zone, config) {
     ...
     * @group Props
     */
    __publicField(this, "promptLabel", "Enter a password");
    /**
     * Text for a weak password. Defaults to PrimeNG I18N API configuration.
     * @group Props
     */
    __publicField(this, "weakLabel", "Weak");
    /**
     * Text for a medium password. Defaults to PrimeNG I18N API configuration.
     * @group Props
     */
    __publicField(this, "mediumLabel", "Medium");
    /**
     * Text for a strong password. Defaults to PrimeNG I18N API configuration.
     * @group Props
     */
    __publicField(this, "strongLabel", "Strong");
    /**
     * Whether to show the strength indicator or not.
     * @group Props
     */
    __publicField(this, "feedback", true);
    /**
  ...
  createPanel() {
    if (isPlatformBrowser(this.platformId)) {
      ...
      this.renderer.setStyle(this.panel, "minWidth", "".concat(this.el.nativeElement.offsetWidth, "px"));
...
__publicField(_PasswordDirective, "ɵfac", function PasswordDirective_Factory(__ngFactoryType__) {
...
__publicField(_PasswordDirective, "ɵdir", ɵɵdefineDirective({
...
var PasswordDirective = _PasswordDirective;
(() => {
...
var _MapperPipe = class _MapperPipe {
  transform(value, mapper, ...args) {
    return mapper(value, ...args);
  }
};
__publicField(_MapperPipe, "ɵfac", function MapperPipe_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _MapperPipe)();
});
__publicField(_MapperPipe, "ɵpipe", ɵɵdefinePipe({
  name: "mapper",
  type: _MapperPipe,
  pure: true
}));
var MapperPipe = _MapperPipe;
(() => {
...
var _Password = class _Password {
  constructor(document2, platformId, renderer, cd, config, el, overlayService) {
     ...
     * @group Props
     */
    __publicField(this, "promptLabel");
    /**
     * Regex value for medium regex.
     * @group Props
     */
    __publicField(this, "mediumRegex", "^(((?=.*[a-z])(?=.*[A-Z]))|((?=.*[a-z])(?=.*[0-9]))|((?=.*[A-Z])(?=.*[0-9])))(?=.{6,})");
    /**
     * Regex value for strong regex.
     * @group Props
     */
    __publicField(this, "strongRegex", "^(?=.*[a-z])(?=.*[A-Z])(?=.*[0-9])(?=.{8,})");
    /**
     * Text for a weak password. Defaults to PrimeNG I18N API configuration.
     * @group Props
     */
    __publicField(this, "weakLabel");
    /**
     * Text for a medium password. Defaults to PrimeNG I18N API configuration.
     * @group Props
     */
    __publicField(this, "mediumLabel");
    /**
     ...
     * @group Props
     */
    __publicField(this, "strongLabel");
    /**
    ...
    __publicField(this, "hideIconTemplate");
    __publicField(this, "showIconTemplate");
    __publicField(this, "templates");
    __publicField(this, "overlayVisible", false);
    __publicField(this, "meter");
    __publicField(this, "infoText");
    __publicField(this, "focused", false);
    __publicField(this, "unmasked", false);
    __publicField(this, "mediumCheckRegExp");
    __publicField(this, "strongCheckRegExp");
  ...
  strengthClass(meter) {
    return "p-password-strength ".concat(meter ? meter.strength : "");
  }
  filled() {
...
__publicField(_Password, "ɵfac", function Password_Factory(__ngFactoryType__) {
...
__publicField(_Password, "ɵcmp", ɵɵdefineComponent({
  type: _Password,
...
var _PasswordModule = class _PasswordModule {
};
__publicField(_PasswordModule, "ɵfac", function PasswordModule_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _PasswordModule)();
});
__publicField(_PasswordModule, "ɵmod", ɵɵdefineNgModule({
