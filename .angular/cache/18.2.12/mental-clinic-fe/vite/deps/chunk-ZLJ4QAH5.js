...
var _ButtonDirective = class _ButtonDirective {
  constructor(el, document) {
    ...
    __publicField(this, "_internalClasses", Object.values(INTERNAL_BUTTON_CLASSES));
    this.el = el;
  ...
  getStyleClass() {
    ...
    if (this.severity) {
      styleClass.push("p-button-".concat(this.severity));
    }
    if (this.plain) {
    ...
    if (this.size) {
      styleClass.push("p-button-".concat(this.size));
    }
    if (this.outlined) {
  ...
  getIconClass() {
    var _a;
    return this.loading ? "p-button-loading-icon pi-spin " + ((_a = this.loadingIcon) != null ? _a : "pi pi-spinner") : this.icon || "p-hidden";
  }
  ngOnDestroy() {
    this.initialized = false;
  }
};
__publicField(_ButtonDirective, "ɵfac", function ButtonDirective_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _ButtonDirective)(ɵɵdirectiveInject(ElementRef), ɵɵdirectiveInject(DOCUMENT));
});
__publicField(_ButtonDirective, "ɵdir", ɵɵdefineDirective({
...
var _Button = class _Button {
  ...
  spinnerIconClass() {
    return Object.entries(this.iconClass()).filter(([, value]) => !!value).reduce((acc, [key]) => acc + " ".concat(key), "p-button-loading-icon");
  }
  iconClass() {
    var _a;
    const iconClasses = {
    ...
    if (this.loading) {
      iconClasses["p-button-loading-icon pi-spin ".concat((_a = this.loadingIcon) != null ? _a : "")] = true;
    } else if (this.icon) {
  ...
  get buttonClass() {
    return {
      ...
      ["p-button-".concat(this.severity)]: this.severity,
      ...
      ["".concat(this.styleClass)]: this.styleClass
    };
  }
  ngAfterContentInit() {
    var _a;
...
__publicField(_Button, "ɵfac", function Button_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _Button)(ɵɵdirectiveInject(ElementRef));
});
__publicField(_Button, "ɵcmp", ɵɵdefineComponent({
  type: _Button,
  selectors: [["p-button"]],
...
__publicField(_ButtonModule, "ɵfac", function ButtonModule_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _ButtonModule)();
});
__publicField(_ButtonModule, "ɵmod", ɵɵdefineNgModule({
  type: _ButtonModule,
  imports: [ButtonDirective, Button],
  exports: [ButtonDirective, Button, SharedModule]
}));
__publicField(_ButtonModule, "ɵinj", ɵɵdefineInjector({
...
//# sourceMappingURL=chunk-ZLJ4QAH5.js.map
