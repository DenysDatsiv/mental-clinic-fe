...
var _DomHandler = class _DomHandler {
  ...
  static alignOverlay(overlay, target, appendTo = "self", calculateMinWidth = true) {
    if (overlay && target) {
      if (calculateMinWidth) {
        overlay.style.minWidth = "".concat(_DomHandler.getOuterWidth(target), "px");
      }
      if (appendTo === "self") {
  ...
  static relativePosition(element, target, gutter = true) {
    ...
    const targetHeight = (_a = target.offsetHeight) != null ? _a : target.getBoundingClientRect().height;
    const targetOffset = target.getBoundingClientRect();
    const windowScrollTop = this.getWindowScrollTop();
    const windowScrollLeft = this.getWindowScrollLeft();
    const viewport = this.getViewport();
    const relativeElement = getClosestRelativeElement(element);
    const relativeElementOffset = (relativeElement == null ? void 0 : relativeElement.getBoundingClientRect()) || {
  ...
  static absolutePosition(element, target, gutter = true) {
    ...
    const targetOuterHeight = (_a = target.offsetHeight) != null ? _a : target.getBoundingClientRect().height;
    const targetOuterWidth = (_b = target.offsetWidth) != null ? _b : target.getBoundingClientRect().width;
    const targetOffset = target.getBoundingClientRect();
    const windowScrollTop = this.getWindowScrollTop();
    const windowScrollLeft = this.getWindowScrollLeft();
    const viewport = this.getViewport();
  ...
  static getFocusableSelectorString(selector = "") {
    return 'button:not([tabindex = "-1"]):not([disabled]):not([style*="display:none"]):not([hidden])'.concat(selector, ',\n        [href][clientHeight][clientWidth]:not([tabindex = "-1"]):not([disabled]):not([style*="display:none"]):not([hidden])').concat(selector, ',\n        input:not([tabindex = "-1"]):not([disabled]):not([style*="display:none"]):not([hidden])').concat(selector, ',\n        select:not([tabindex = "-1"]):not([disabled]):not([style*="display:none"]):not([hidden])').concat(selector, ',\n        textarea:not([tabindex = "-1"]):not([disabled]):not([style*="display:none"]):not([hidden])').concat(selector, ',\n        [tabIndex]:not([tabIndex = "-1"]):not([disabled]):not([style*="display:none"]):not([hidden])').concat(selector, ',\n        [contenteditable]:not([tabIndex = "-1"]):not([disabled]):not([style*="display:none"]):not([hidden])').concat(selector, ',\n        .p-inputtext:not([tabindex = "-1"]):not([disabled]):not([style*="display:none"]):not([hidden])').concat(selector, ',\n        .p-button:not([tabindex = "-1"]):not([disabled]):not([style*="display:none"]):not([hidden])').concat(selector);
  }
  ...
  static getTargetElement(target, el) {
    ...
    switch (target) {
      ...
      case "window":
        return window;
      case "@next":
        return el == null ? void 0 : el.nextElementSibling;
      case "@prev":
        return el == null ? void 0 : el.previousElementSibling;
      case "@parent":
        return el == null ? void 0 : el.parentElement;
      case "@grandparent":
        return el == null ? void 0 : el.parentElement.parentElement;
      default:
        ...
        return [value].flat().reduce((cv, v) => {
          if (v !== null && v !== void 0) {
            ...
            if (type === "string" || type === "number") {
              ...
              const _cv = Array.isArray(v) ? computedStyles(rule, v) : Object.entries(v).map(([_k, _v]) => rule === "style" && (!!_v || _v === 0) ? "".concat(_k.replace(/([a-z])([A-Z])/g, "$1-$2").toLowerCase(), ":").concat(_v) : !!_v ? _k : void 0);
...
//# sourceMappingURL=chunk-LB42WWNC.js.map
